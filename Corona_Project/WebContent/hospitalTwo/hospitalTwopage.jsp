...
function CallData(){
	$.ajax({
    	url: 'hospitalTwoloc.txt',
    	dataType: 'text',
 	 }).done(getMap);
}

var imageSrc = '/Corona_Project/resources/images/hospitalTwo/hospitalTwo.png', // 마커이미지의 주소입니다    
...
//주소로 좌표를 검색합니다
geocoder.addressSearch(rowCells[5], function(result, status) {
// 정상적으로 검색이 완료됐으면 
g_cnt += 1;
//alert(g_cnt+"g_cnt");
